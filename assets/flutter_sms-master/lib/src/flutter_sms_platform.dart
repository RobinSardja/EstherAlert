...
class FlutterSmsPlatform extends PlatformInterface {
  ...
  Future<bool> launchSmsMulti(List<String> numbers, [String? body]) {
    ...
    if (body != null) {
      final uriBody = Uri.encodeComponent(body);
      return launchUrl( Uri( scheme:'sms:/open?addresses=$phones${separator}body=$uriBody' ) );
    }
    return launchUrl( Uri( scheme:'sms:/open?addresses=$phones' ) );
  }
  ...
  Future<bool> launchSms(String? number, [String? body]) {
    ...
    if (body != null) {
      final uriBody = Uri.encodeComponent(body);
      return launchUrl( Uri( scheme:'sms:/$number${separator}body=$uriBody' ) );
    }
